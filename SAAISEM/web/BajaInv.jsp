...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="col-sm-12">
                <h4>Baja de Insumos por Movimiento al Inventario</h4>
            </div>
            <br />
            <hr/>
            <form action="BajaInv" method="get" name="formulario" id="formulario">
                <div class="row">                    

                    <div class="panel-footer">
                        <div class="row">
                            <h5>IMPORTANTE! Este proceso solo debe EJECUTARSE en una sola Computadora a la Vez</h5>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <button class="btn btn-block btn-info" type="submit" id="btn_capturar" name="btn_capturar" onclick="">Baja Inventario</button>
                                    </div>
                                </div>
                            </div>   
                        </div> 
            ...
            <script>
                ...
                $(document).ready(function () {
                    $("#formulario").submit(function () {
                        ...
                        var valida = confirm('Seguro que desea dar de Baja todas las Existencias?');
                        if (valida) {
                            $('#formCambio').submit();
