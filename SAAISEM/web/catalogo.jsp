        ...
        <div class="container">
            <div class="panel panel-success">
                <div class="panel-heading">
                   ...
                   <% if(tipo.equals("1") || tipo.equals("11") || tipo.equals("13")){ %>
                    ...
                    <form class="form-horizontal" role="form" name="formulario1" id="formulario1" method="post" action="Proveedores">
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <div class="col-lg-2 navbar-right"><a class="btn btn-block btn-danger" onclick="window.close();">Salir <span class="glyphicon glyphicon-log-out"></a></div>
                            </div>
