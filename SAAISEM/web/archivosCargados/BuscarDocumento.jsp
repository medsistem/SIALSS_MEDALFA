...
<% 
    String tipoDoc = "";
    tipoDoc = request.getParameter("tipo");
    String titulo = "Folios entregados a farmacia";
    if(tipoDoc == null){
        tipoDoc = "recibo";
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body" >
                    <div class="row">
                        ...
                        <label class="col-lg-1 col-md-2 col-sm-2" style="margin-top: 5px" for="fileName">Nombre:</label>
                        <div class="col-lg-3 col-md-3 col-sm-3" >
                            <input type="text" class="form-control" id="fileName">
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-1" >
                            <button type="button" class="btn btn-block btn-primary" id="searchFile" >
...
<!--                        <div class="col-lg-1 col-md-1 col-sm-1" >
        ...
        <script>
            localStorage.setItem("tipo","<%=tipoDoc%>");
            $("#fechaBusquedaInput").datepicker({dateFormat: 'yy-mm-dd'});
            var porFecha = <%=StaticText.KARDEX_POR_FECHA%>;
        </script>
        <script src="${generalContext}/js/archivosCargados/buscarDocumento.js"></script>
    </body>
</html>
