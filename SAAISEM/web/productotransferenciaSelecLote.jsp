                    ...
                    <div class="panel-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-2 col-sm-offset-6">
                                <a class="btn btn-block btn-default" href="productotransferencia.jsp">Regresar</a>
                            </div>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <form action="FacturacionManual" method="post">
                            ...
                            <button name="accion" type="button" value="AgregarClaveFOLIO" id="BtnAgregar_<%=rset.getString(6)%>" class="btn btn-block btn-success" onclick="return validaCantidad(this.id);"><span class="glyphicon glyphicon-ok"></span></button>
