                    ...
                    <table class="table table-bordered table-striped table-condensed" id="tablaUsuario">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="nombre"><c:out value="${detalle.nombre}" />&nbsp;<c:out value="${detalle.apaterno}" />&nbsp;<c:out value="${detalle.amaterno}" /></td>
                                <td class="sts"><c:out value="${detalle.sts}" /></td>
                                <td>
                                    <a href="EditaPassword?Id=${detalle.id}&action=Modifica" class="btn btn-info glyphicon glyphicon-pencil" title="Modificar Password"></a>                                    
