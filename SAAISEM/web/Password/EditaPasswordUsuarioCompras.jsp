            ...
            <form action="${pageContext.request.contextPath}/EditaPassword" method="post">
                ...
                <div class="row">
                    <label class="col-sm-12">
                        <h4>Nombre: ${usuario.nombre} ${usuario.apaterno} ${usuario.amaterno}</h4>
                    </label>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <button class="form-control btn btn-block btn-info " type="submit" name="action" id="action" value="ActualizarPassCompras" onclick="return valida_alta();" >Actualizar</button>
                    </div>
                </div>
                <br/>
            </form>
