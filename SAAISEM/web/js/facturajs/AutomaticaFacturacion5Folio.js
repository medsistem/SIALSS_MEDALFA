            ...
            swal({
                ...
                confirmButtonText: "Continuar!"
                    ...
                    function () {
                        ...
                        $.ajax({
                            url: "FacturacionTran",
                            data: {accion: "GeneraFolioApart5Folio", ClaUni: checkboxValues, Catalogo: Catalogo, Tipo: Tipo, FecEnt: FecEnt, Proyecto: Proyecto, OC: OC},
                            type: 'GET',
                            dataType: 'JSON',
                            async: true,
                            success: function (data) {
                                if (data.msj) {
                                    $.ajax({
                                        url: "FacturacionTran",
                                        data: {accion: "GeneraFolio5Folio", ClaUni: checkboxValues, Catalogo: Catalogo, Tipo: Tipo, FecEnt: FecEnt, Proyecto: Proyecto, OC: OC},
                                        type: 'GET',
                                        dataType: 'JSON',
                                        async: true,
                                        success: function (data) {
