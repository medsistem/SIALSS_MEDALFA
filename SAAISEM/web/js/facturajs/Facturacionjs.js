            ...
            swal({
                ...
                confirmButtonText: "Continuar!"
                    ...
                    function () {
                        ...
                        $.ajax({
                            url: "FacturacionTran",
                            data: {accion: "ConformarFactTemp", Obs: Obs, Tipo: Tipo, Proyecto: Proyecto, OC: OC},
                            type: 'POST',
                            dataType: 'JSON',
                            async: true,
...
function validaCantidad(e) {
    ...
    document.getElementById('Cant' + id).value = cantidadSol;
    var cantidadAlm = document.getElementById('CantAlm_' + id).value;
    ...
    var isControlado = document.getElementById('controlado' + id).value;
    if (isControlado === 'true') {
        var cadControlado = document.getElementById('cadControlado' + id).value;
        if (cadControlado > 0) {
