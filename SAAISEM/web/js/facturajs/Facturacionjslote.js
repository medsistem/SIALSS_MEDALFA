...
$(document).ready(function () {
    ...
    $('#BtnConfirmar').click(function () {
        ...
        var OC = $("#OC").val();
        var ClaCli = $("#ClaCliSelect").val();
        if (ClaCli != "") {
            if (Obs != "") {
                swal({
                    title: "¿Seguro de confirmar la Factura por Lote?",
                    ...
                    confirmButtonText: "Continuar!"
                        ...
                        function () {
                            ...
                            $.ajax({
                                url: "FacturacionTran",
                                data: {accion: "ConformarFactTempLote", Obs: Obs, Tipo: Tipo, Proyecto: Proyecto, OC: OC, ClaCli: ClaCli},
                                type: 'POST',
                                dataType: 'JSON',
                                async: true,
                                success: function (data) {
                                    if (data.msj) {
                                        swal({
                                            ...
                                            //location.reload();
                                            window.location = "FacturacionTran?accion=TerminoCapturaLote";
                                        });
            ...
            swal("Atención", "Favor de seleccionar unidad", "warning");
        }
    });
