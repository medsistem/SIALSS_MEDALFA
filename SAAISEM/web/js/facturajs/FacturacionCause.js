...
$(document).ready(function () {
    ...
    $('#BtnConfirmar').click(function () {
        ...
        if (Cause != "") {
                ...
                swal({
                    ...
                    confirmButtonText: "Continuar!"
                        ...
                        function () {
                            ...
                            $.ajax({
                                url: "FacturacionTran",
                                data: {accion: "ConformarFactTempCause", Obs: Obs, Tipo: Tipo, Proyecto: Proyecto, OC: OC, Cause: Cause},
                                type: 'POST',
                                dataType: 'JSON',
                                async: true,
                                success: function (data) {
                                    if (data.msj) {
                                        swal({
                                            ...
                                            //location.reload();
                                            window.location = "FacturacionTran?accion=TerminoCapturaCause";
                                        });
            ...
            swal("Atención", "Favor de seleccionar Cause", "warning");
        }
    });
                ...
                $('#BtnAgregar_' + elem.IdReg).click(function () {
                    ...
                    if (parseInt(Cantidad) > parseInt(elem.Existencia)) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.msj) {
                                    window.location = "FacturacionTran?accion=RegresarCapturaCause";
                                } else {
