            ...
            swal({
                ...
                confirmButtonText: "Continuar!"
                    ...
                    function () {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "FacturacionTran?accion=obtenerIdRegFactAutoLote&ClaUni=" + checkboxValues + "&Catalogo=" + Catalogo + "",
                            dataType: "json",
                            async: false,
                            success: function (data) {
                                $.each(data, function (idx, elem) {
                                    ...
                                    $.ajax({
                                        url: "FacturacionTran",
                                        data: {accion: "ActualizaReqIdLote", ClaUni: elem.ClaUni, ClaPro: elem.ClaPro, IdRegistro: elem.IdReg, Catalogo: Catalogo, Cantidad: Cantidad, Obs: Obs},
                                        type: 'GET',
                                        dataType: 'JSON',
                                        async: true,
                                        success: function (data) {
                        ...
                        $.ajax({
                            url: "FacturacionTran",
                            data: {accion: "GeneraFolioLote", ClaUni: checkboxValues, Catalogo: Catalogo, Tipo: Tipo, FecEnt: FecEnt, Proyecto: Proyecto},
                            type: 'GET',
                            dataType: 'JSON',
                            async: true,
                            success: function (data) {
                                if (data.msj) {
                                    swal({
                                        ...
                                        //location.reload();
                                        window.location = "facturaAtomaticaLote.jsp";
                                    });
