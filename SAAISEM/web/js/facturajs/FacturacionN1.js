            ...
            swal({
                ...
                confirmButtonText: "Continuar!"
                    ...
                    function () {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "FacturacionTran?accion=obtenerIdRegFactAutoNivel&ClaUni=" + checkboxValues + "&Catalogo=" + Catalogo + "",
                            dataType: "json",
                            async: false,
                            success: function (data) {
                                $.each(data, function (idx, elem) {
                                    ...
                                    $.ajax({
                                        url: "FacturacionTran",
                                        data: {accion: "ActualizaReqId", ClaUni: elem.ClaUni, ClaPro: elem.ClaPro, IdRegistro: elem.IdReg, Catalogo: Catalogo, Cantidad: Cantidad, CantidadReq: CantidadReq, Obs: Obs},
                                        type: 'GET',
                                        dataType: 'JSON',
                                        async: true,
                                        success: function (data) {
                        ...
                        $.ajax({
                            url: "FacturacionTran",
                            data: {accion: "GeneraFolioN1", ClaUni: checkboxValues, Catalogo: Catalogo, Tipo: Tipo, FecEnt: FecEnt, Proyecto: Proyecto, OC: OC},
                            type: 'GET',
                            dataType: 'JSON',
                            async: true,
                            success: function (data) {
