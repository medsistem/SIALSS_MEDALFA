                    ...
                    <div class="panel-footer">
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <button class="btn btn-block btn-success" type = "submit" value = "codigo" name = "accion" >Código</button>
                                </div>
                            </div>
                        </div>
                        <%
                        ...
                        <%
                            if(Cuenta == 0){
                        %>
                        <button class="btn btn-block btn-success" type="submit" name="accion" value="capturar" onclick="return (validaCapturaVacios());">Capturar</button>
                        <%}else{%>
                        <button class="btn btn-block btn-success" type="submit" name="accion" value="capturarcb" onclick="return (validaCapturaVacioscb());">Capturar</button>
                        <%}%>
                        <!-- En duda -->
                    </div>
                </form>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="get" action="Modificaciones">
                                ...
                                <button class="btn btn-success" onclick="return confirm('¿Seguro de que desea eliminar?');" name="accion" value="eliminar"><span class="glyphicon glyphicon-remove"></span></button>
                            </form>
                        </td>
                    </tr>
                    <%
