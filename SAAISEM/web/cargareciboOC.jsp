...
<%
    ...
    String usua = "", tipo = "", Proyecto = "", DesProyecto = "", Campo = "";
        ...
        <div class="container">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Cargar OC Proyecto <%=DesProyecto%> </h3>
                </div>
                <div class="panel-body ">
                    <form method="post" class="jumbotron"  action="FileUploadServletReciboCompras" enctype="multipart/form-data" name="form1">
                        <input name="Proyecto" id="Proyecto" value="<%=Proyecto%>" type="hidden" />
                        <input name="DesProyecto" id="DesProyecto" value="<%=DesProyecto%>" type="hidden" />
                        <input name="Campo" id="Campo" value="<%=Campo%>" type="hidden" />
