...
<%
    ...
    int tipo = 0, F_IncMen = 0, CantMax = 0, F_Origen = 0;
    int ban1 = 0, ban2 = 0, ban3 = 0, ban4 = 0, ban5 = 0, ban6 = 0, ban7 = 0, ban8 = 0, ban9 = 0, ban10 = 0, ban11 = 0, ban12 = 0, ban13 = 0, ban14 = 0, ban15 = 0, ban16 = 0, ban216 = 0, ban17 = 0, ban217 = 0, ban18 = 0, ban19 = 0, ban20 = 0, ban30 = 0;
    int bProIsem = 0;
    ...
    //boolean editable = Calendario.first3WorkDays();
    ...
    try {
        ...
        while (rset.next()) {
            ...
            ban13 = rset.getInt(21);
            ban14 = rset.getInt(22);
            ban15 = rset.getInt(23);
            ban16 = rset.getInt(24);
            ban17 = rset.getInt(25);
            OriNim = rset.getString(26);
            CostoNim = rset.getString(27);
            Grupo = rset.getString(28);
            Comentario = rset.getString(29);
            Catalogo = rset.getString(30);
            CantMax = rset.getInt(31);
            bProIsem = rset.getInt(32);
        }
        con.cierraConexion();
    } catch (Exception e) {
                    ...
                    <form class="form-horizontal" role="form" name="formulario1" id="formulario1" method="post" action="Medicamentos">
                        <div class="row">
                            <div class="form-group">                                
                                ...
                                <label for="Sts" class="col-xs-2 control-label">Status</label>
                                <div class="col-xs-2">                                    
                            ...
                            <div class="row">
                                ...
                                <br/>
                        <div class="row">
                            <label for="list_medica" class="col-xs-2 control-label">Tipo de Insumo</label>
                            <div class="col-xs-3">                                    
                                <%if (tipo == 2504) {%>
                                ...
                                <%} else {%>
                                <input type="radio" name="radiotipo" id="radiotipo" value="2504">Medicamento&nbsp;<input type="radio" name="radiotipo" id="radiotipo" checked="" value="2505">Mat. Curación
                                <%}%>
                            </div>
                            ...
                            <div class="col-xs-11">
                                <table  class="table" id="datosOrigen">     
                                    <tbody>
                                        <tr>  
                                    <%if (ban1 == 1) {%>
                                            <td><input type="checkbox" name="cat1" id="cat1" checked="" value="1">(1) UM y C&nbsp;</td>
                                                <%} else {%>
                                            <td><input type="checkbox" name="cat1" id="cat1" value="1">(1) UM y C&nbsp;</td>
                                                <%}
                                    if (ban2 == 1) {%>
                                            <td><input type="checkbox" name="cat2" id="cat2" checked="" value="2">(2) CSR&nbsp;</td>
                                                <%} else {%>
                                            <td><input type="checkbox" name="cat2" id="cat2" value="2">(2) CSR&nbsp;</td>
                                                <%}
                                    if (ban3 == 1) {%>
                                            <td><input type="checkbox" name="cat3" id="cat3" checked="" value="3">(3) CSU,CAT,UNEMES y GERIATRICOS&nbsp;</td>           
                                                <%} else {%>
                                            <td><input type="checkbox" name="cat3" id="cat3" value="3">(3) CSU,CAT,UNEMES y GERIATRICOS&nbsp;</td>                                
                                                <%}
                                    if (ban4 == 1) {%>
                                            <td><input type="checkbox" name="cat4" id="cat4" checked="" value="4">(4) CEAPS&nbsp;</td>
                                                <%} else {%>
                                    ...
                                    <%if (ban5 == 1) {%>
                                            ...
                                            <td><input type="checkbox" name="cat5" id="cat5" checked="" value="5">(5) CISAME&nbsp;</td>
                                                <%} else {%>
                                            <td><input type="checkbox" name="cat5" id="cat5" value="5">(5) CISAME&nbsp;</td>
                                                <%}
                                    if (ban6 == 1) {%>
                                            <td><input type="checkbox" name="cat6" id="cat6" checked="" value="6">(6) MAT&nbsp;</td>
                                                <%} else {%>
                                            <td><input type="checkbox" name="cat6" id="cat6" value="6">(6) MAT&nbsp;</td>
                                                <%}
                                    if (ban7 == 1) {%>
                                            <td><input type="checkbox" name="cat7" id="cat7" checked="" value="7">(7) MOyCAE&nbsp;</td>
                                                <%} else {%>
                                            <td><input type="checkbox" name="cat7" id="cat7" value="7">(7) MOyCAE&nbsp;</td>
                                                <%}
                                    if (ban8 == 1) {%>
                                            <td><input type="checkbox" name="cat8" id="cat8" checked="" value="8">(8) HM&nbsp;</td>
                                                <%} else {%>
                                    ...
                                    <%if (ban9 == 1) {%>
                                            ...
                                            <td><input type="checkbox" name="cat9" id="cat9" checked="" value="9">(9) HG&nbsp;</td>       
                                                <%} else {%>
                                            <td><input type="checkbox" name="cat9" id="cat9" value="9">(9) HG&nbsp;</td>
                                                <%}
                                    if (ban10 == 1) {%>
                                            <td><input type="checkbox" name="cat10" id="cat10" checked="" value="10">(10) HMI&nbsp;</td>
                                                <%} else {%>
                                            <td><input type="checkbox" name="cat10" id="cat10" value="10">(10) HMI&nbsp;</td>
                                                <%}
                                    if (ban11 == 1) {%>
                                            <td><input type="checkbox" name="cat11" id="cat11" checked="" value="11">(11) HSV&nbsp;</td>
                                                <%} else {%>
                                            <td><input type="checkbox" name="cat11" id="cat11" value="11">(11) HSV&nbsp;</td>
                                                <%}
                                    if (ban12 == 1) {%>
                                            <td><input type="checkbox" name="cat12" id="cat12" checked="" value="12">(12) HMI PRETELINI&nbsp;</td>
                                                <%} else {%>
                                    ...
                                    <%if (ban13 == 1) {%>
                                            ...
                                            <td> <input type="checkbox" name="cat13" id="cat13" checked="" value="13">(13) CM &nbsp;</td>    
                                                <%} else {%>
                                            <td> <input type="checkbox" name="cat13" id="cat13" value="13">(13) CM &nbsp;</td>
                                                <%}
                                    if (ban14 == 1) {%>

                                            <td><input type="checkbox" name="cat14" id="cat14"  checked="" value="14">(14) HP&nbsp;</td>
                                                <%} else {%>
                                            <td><input type="checkbox" name="cat14" id="cat14" value="14">(14) HP&nbsp;</td>
                                                <%}
                                    if (ban15 == 1) {%>
                                            <td><input type="checkbox" name="cat15" id="cat15" checked="" value="15">(15) S.U.E.M.&nbsp;</td>
                                                <%} else {%>
                                            <td><input type="checkbox" name="cat15" id="cat15" value="15">(15) S.U.E.M.&nbsp;</td>
                                                <%}
                                    if (ban16 == 1) {%>
                                            <td><input type="checkbox" name="cat16" id="cat16" checked="" value="16">(16) LESP&nbsp;</td>
                                                <%} else {%>
                        ...
                        <div class="row">
                            ...
                            <label for="origennim" class="col-sm-1 control-label">Origen NIM</label>
                            <div class="col-sm-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                               <!--  < % 
                                ...
                                %>-->
                                <button class="btn btn-block btn-success" type="submit" name="accion" value="Modificar">Modificar</button>
                                <!--< %
                                    }else{
                                %>
                                <label> Solo se puede editar los primeros tres días hábiles</label>
                                < %
                                    }
                                %>-->
                            </div>
                            ...
                            <div class="col-sm-6">
                                <a href="medicamento.jsp" class="btn btn-block btn-warning" type="submit" name="accion" value="Regresar">Regresar</a>   
                            </div>
                        </div>
                    </form>
                    <div>
