...
<html>
    ...
    <body>
        <div class="container">
            ...
            <br />
            <hr/>
            <form action="ExportarRequeLocal.jsp" method="get">
                <div class="row">
                            ...
                            <div class="col-lg-5">
                                    <select class="form-control" name="Juris" id="Juris" >
                                            ...
                                            try {
                                                con.conectar();
                                                try {
                                                            ResultSet RsetJur = con.consulta("SELECT US.F_Juris, US.F_JurisDes FROM tb_requerimientos R INNER JOIN tb_uniatn U ON R.F_ClaCli = U.F_ClaCli INNER JOIN tb_usuariounidades US ON R.F_ClaCli = US.F_ClaCli AND U.F_ClaCli = US.F_ClaCli WHERE R.F_StsReq IN (3, 4) AND F_Periodo !='' AND F_FecCap>='2017-12-31 0:00:00' AND F_Periodo !='DICIEMBRE-2017' GROUP BY US.F_Juris;");
                                                            while (RsetJur.next()) {
                                                            %>
                        ...
                        <table class="table table-bordered table-striped" id="datosCompras">
                            ...
                            <tbody>
                                <%
                                    try {
                                        ...
                                        try {
                                            ...
                                            ResultSet rset = con.consulta("SELECT R.F_ClaCli, U.F_NomCli, R.F_IdReq, R.F_StsReq, FORMAT(SUM(D.F_Cant), 0) AS F_Cant FROM tb_requerimientos R INNER JOIN tb_uniatn U ON R.F_ClaCli = U.F_ClaCli INNER JOIN tb_detrequerimiento D ON R.F_IdReq = D.F_IdReq INNER JOIN tb_usuariounidades US ON R.F_ClaCli = US.F_ClaCli AND U.F_ClaCli = US.F_ClaCli WHERE R.F_StsReq IN (3, 4) AND US.F_Juris = '"+Juris+"' AND R.F_Periodo = '"+Mess+"' GROUP BY R.F_ClaCli, US.F_NomCli, R.F_IdReq, R.F_StsReq;");
                                            while (rset.next()) {
                                ...
                                <tr>
                                    ...
                                    <td><%=F_Cant%></td>
                                    <td>
                                        <a class="btn btn-block btn-success" href="gnrReqLocal.jsp?fol_gnkl=<%=rset.getString(3)%>"><span class="glyphicon glyphicon-save"></span></a>
                                    </td>
                                    <!--td>
                                        <form action="../ReportesPuntos/reimpRequerimientoLocal.jsp" target="_blank">
