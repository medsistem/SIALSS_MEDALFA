...
<%
    ...
    try {
        ...
        Logger.getLogger("reimpresionLocal.jsp").log(Level.SEVERE, null, e);
    } finally {
        try {
            con.cierraConexion();
        } catch (Exception ex) {
            Logger.getLogger("reimpresionLocal.jsp").log(Level.SEVERE, null, ex);
        }
    }
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    <form action="../ProcesaRequerimientoLocal" method="post" onsubmit="muestraImagen()">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                N°. Req:&nbsp;<label><%=IdReq%></label> | Clave Uni:&nbsp;<label><%=ClaveU%></label> | Nombre:&nbsp;<label><%=NombreU%></label> 
                            </div>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-condensed" id="datosProv">
                                        ...
                                        <%
                                            try {
                                                ...
                                                Consulta = con.consulta("SELECT R.F_ClaPro,M.F_DesPro,R.F_Cant,R.F_Id,R.F_CantInv FROM tb_requerimientoprocesar R INNER JOIN tb_medica M ON R.F_ClaPro=M.F_ClaPro WHERE F_IdReq='" + IdReq + "' AND F_Cant>0");
                                                while (Consulta.next()) {
        ...
        <div id="ModiOc" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form name="formEditOC" action="../ProcesaRequerimientoLocal" method="Post">
