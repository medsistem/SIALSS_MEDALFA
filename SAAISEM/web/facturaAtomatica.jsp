...
<html>
                                        ...
                                        <%
                                            try {
                                               ...
                                               //         UbicaDesc = " WHERE F_Ubica IN ('AF3','APE','DENTAL','REDFRIA','CONTROLADO')";
                                                 //  if (UbicaModu == 1) {
                                                  //      UbicaDesc = " WHERE l.F_Ubica IN ('MODULA','A0S','APE','DENTAL','REDFRIA')";
                                                  //  } else if (UbicaModu == 2) {
                                                  //      UbicaDesc = " WHERE l.F_Ubica IN ('MODULA2','A0S','APE','DENTAL','REDFRIA')";
                                                 //   } else if (UbicaModu == 3) {
                                                 //       UbicaDesc = " WHERE l.F_Ubica IN ('AF','APE','DENTAL','REDFRIA')";
                                                  //  } else {
                                                     //   String Ubicaciones = "", UbicaNofacturar = "", UbicaTemporal = "";
                                                     //   ResultSet rsetUbica = rsetUbica = con.consulta("SELECT F_Ubi FROM tb_ubicacrosdock;");
                                                      //  if (rsetUbica.next()) {
                                                       //     Ubicaciones = rsetUbica.getString(1);
                                                       // }
                                                       //     ResultSet rsetUbicaTemp = con.consulta("SELECT F_Ubica FROM tb_ubicatemporal;");
                                                       //     if (rsetUbicaTemp.next()) {
                                                       //         UbicaTemporal = "," + rsetUbicaTemp.getString(1);
                                                     //       }
                                                      ...
                                                      //  if (!(usua.equals("Francisco"))) {
                                                        ...
                                                        //    }
                                                     //
                                                     //   Ubicaciones = Ubicaciones + UbicaNofacturar + UbicaTemporal;

                                                   //     UbicaDesc = " WHERE l.F_Ubica NOT IN ('A0S','MODULA','MODULA2','CADUCADOS','PROXACADUCAR','MERMA','EXTRA_ORDINARIA','CROSSDOCKMORELIA','INGRESOS_V','CUARENTENA'," + Ubicaciones + ")";
                                                  //  }
 ...
 /*else if ((Cata == 2) || (Cata == 14) || (Cata == 16) || (Cata == 216) || (Cata == 17) || (Cata == 217)) {
                                                ...
                                                //ResultSet rsetR1 = con.consulta("SELECT M.F_ClaPro,M.F_DesPro,REQ.F_CajasReq, REQ.F_Solicitado,REPLACE(M.F_ClaPro,'.','') FROM tb_unireq REQ INNER JOIN tb_medica M ON REQ.F_ClaPro=M.F_ClaPro AND F_N" + Catalogo + "='1' AND M.F_StsPro='A' WHERE F_ClaUni='" + rset.getString("F_ClaUni") + "' and F_Status =0 and F_Solicitado != 0 group by F_IdReq order by M.F_ClaPro+0;");
