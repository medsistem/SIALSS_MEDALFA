...
<html>
    ...
    <body>
        <div class="container">
            ...
            <table class="table table-condensed table-striped table-bordered table-responsive" id="selectlotefolio">
                <thead>
                    <tr>
                        <th>CLAVE:</th>
                        <th>Lote</th>
