            ...
            <form id="formParametros" action="../entregas/v2" method="post">
                ...
                <div class="row">
                    ...
                    <div class=" col-sm-3">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong><i>Fuente de Financiamiento</i></strong></h3>
                            </div>
                            <div class="panel-body">
                                <label class="checkbox-inline">
                                    <input type="checkbox" name="FuenteF" id="FuenteF" value="FuenteF" /> FUENTE DE FINANCIAMIENTO
                                </label>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <select name="SelectProyect" id="SelectProyect" class="col-sm-5">
                                        ...
                                        <%
                                            try {
                                                con.conectar();
                                                ResultSet Proyect = con.consulta("SELECT P.F_Id,P.F_DesProy FROM tb_proyectos P ORDER BY P.F_DesProy;");
                                                while (Proyect.next()) {
                                        %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 col-sm-offset-2">
                                        <input type="hidden" name="Reporte" id="Reporte" class="form-control" value="1" />
                                    ...
                                    <div class="col-sm-4">
                                        <a class="btn btn-block btn-success" href="Reporteador.jsp">Limpiar&nbsp;<i class="glyphicon glyphicon-trash"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
