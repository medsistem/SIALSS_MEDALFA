            ...
            <form id="formParametros" action="../entregas/v2" method="post">
                ...
                <div class="row">
                    ...
                    <div class=" col-sm-3">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong><i>Fuente Financiamiento</i></strong></h3>
                            </div>
                            <div class="panel-body">
                                <label class="checkbox-inline">
                                    <input type="checkbox" name="FuenteF" id="FuenteF" value="FuenteF" /> FUENTE FINANCIAMIENTO
                                </label>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 col-sm-offset-2">
                                        <input type="hidden" name="Reporte" id="Reporte" class="form-control" value="2" />
                                    ...
                                    <div class="col-sm-4">
                                        <a class="btn btn-block btn-success" href="ReporteadorCompras.jsp">Limpiar&nbsp;<i class="glyphicon glyphicon-trash"></i></a>                        
                                    </div>    
                                </div>
                            </div>
                        </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#SelectProyect').change(function () {
                    ...
                    if (valor !== '0') {
                        if (Lista !== "") {
                            const grupo = Lista + ",'" + valor + "'";
                            const valores = grupo.split(',').filter((value, index, arr) => index == arr.indexOf(value));
                            const final = valores.join();
                            $('#ListProyect').val(final);
                        } else {
