...
<html>
    ...
    <body>
            ...
            <div class="panel panel-success">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6" >
                            <div class ="form-group">
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="ConsultaDis" id="ConsultaDis">
                                        <option value ="" selected disabled>Seleccionar</option>
                                        <option value="1">Existencias Disponibles</option>
                        ...
                        <div class="col-sm-2">
                             <button type="button" class="btn btn-info btn-sm form-control" id="DescargarDis">Descargar</button>
                        </div>
                    </div>
                </div>
        ...
        <script src="../js/existencia/ExistenciaProyectoCompraDis.js"></script>
