    ...
    <body>
        <div class="container">
            ...
            <form action="leerInsRedist.jsp" method="post">
                ...
                <button type="submit" class="btn btn-block btn-success btn-lg">Insumo Recién Ingresado</button>
            </form>
            <br/>
            <!--a class="btn btn-block btn-success btn-lg" href="ubiAntRedist.jsp">Insumo Ya Ubicado</a-->
            <a class="btn btn-block btn-success btn-lg" href="leerInsRedistCBUbica.jsp">Insumo Ya Ubicado</a>
            <br/>
