...
<html>
        ...
        <div class="container">
            ...
            <div class="panel panel-success">
                <div class="panel-body">
                    <div class="row">
                        <input type="hidden" name="ProyectoCL" id="ProyectoCL" value="<%=ProyectoCL%>"/>
                        <h5 class="col-sm-3">Seleccione Proyecto</h5>
                        <div class="col-sm-3">
    ...
    ================================================== -->
        ...
        <script src="../js/existencia/ExistenciaProyectoCliente.js"></script>
        <!--script src="js/jquery-1.9.1.js"></script-->
    </body>
