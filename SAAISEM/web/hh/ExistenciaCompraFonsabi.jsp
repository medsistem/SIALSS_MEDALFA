...
<html>
        ...
        <div class="container">
            ...
            <div class="panel panel-success">
                ...
                <div style="display:none;" id="Registro">
                    <div class="row">
                        <label class="hidden"><h4>No. Claves : <samp id="totalClave"> </samp></h4></label>
    ...
    ================================================== -->
        ...
        <script src="../js/existencia/ExistenciaCompraFonsabi.js"></script>
        <!--script src="js/jquery-1.9.1.js"></script-->
    </body>
