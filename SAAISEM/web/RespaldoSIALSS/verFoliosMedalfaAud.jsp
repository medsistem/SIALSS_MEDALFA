                        ...
                        <div class="col-sm-6">
                            <select class="form-control" name="Usuario" id="Usuario" onchange="">
                                ...
                                <%
                                    try {
                                        con.conectar();
                                        ResultSet rset = con.consulta("SELECT u.F_IdUsu, u.F_Usu FROM tb_usuario u, tb_pedido_sialss p WHERE  u.F_IdUsu = p.F_IdUsu GROUP BY F_IdUsu;");
                                        while (rset.next()) {
                                %>
                                <option value="<%=rset.getString(1)%>" ><%=rset.getString(2)%></option>
                                <%
                        ...
                        <tbody>
                            <%
                                ...
                                try {
                                    ...
                                    if (!(Proveedor.equals(""))) {
                                        rset = con.consulta("SELECT o.F_NoCompra, u.F_Usu, p.F_NomPro, DATE_FORMAT(o.F_FecSur, '%d/%m/%Y') F_FecSur, F_HorSur, F_Fecha FROM tb_pedido_sialss o, tb_proveedor p, tb_usuario u WHERE u.F_IdUsu = o.F_IdUsu AND o.F_Provee = p.F_ClaProve and o.F_Provee = '" + request.getParameter("Proveedor") + "' AND F_StsPed < 3 group by o.F_NoCompra;");

                                    } else if (!(fecha.equals(""))) {
                                        rset = con.consulta("SELECT o.F_NoCompra, u.F_Usu, p.F_NomPro, DATE_FORMAT(o.F_FecSur, '%d/%m/%Y') F_FecSur, F_HorSur, F_Fecha FROM tb_pedido_sialss o, tb_proveedor p, tb_usuario u WHERE u.F_IdUsu = o.F_IdUsu AND o.F_Provee = p.F_ClaProve and o.F_FecSur =  '" + fecha + "%' AND F_StsPed < 3 group by o.F_NoCompra;");

                                    } else if (!(Usuario.equals(""))) {
                                        rset = con.consulta("SELECT o.F_NoCompra, u.F_Usu, p.F_NomPro, DATE_FORMAT(o.F_FecSur, '%d/%m/%Y') F_FecSur, F_HorSur, F_Fecha FROM tb_pedido_sialss o, tb_proveedor p, tb_usuario u WHERE u.F_IdUsu = o.F_IdUsu AND o.F_Provee = p.F_ClaProve and o.F_IdUsu = '" + request.getParameter("Usuario") + "' AND F_StsPed < 3 group by o.F_NoCompra");
                                    }
