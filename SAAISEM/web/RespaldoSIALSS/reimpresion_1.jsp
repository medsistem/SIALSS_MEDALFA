    ...
    <body>
        <div class="container">
            ...
            <div>
                ...
                <form name="FormOC" action="reimpresion.jsp" method="Post">
                    <div class="row">
                            ...
                            <table class="table table-bordered table-striped" id="datosCompras">
                                <thead>
                                    <tr>
                                        ...
                                        <td>Proveedor</td>
                                        <td>Compra</td>
                                        <td>Tarimas Completas</td>
                                        <td>Tarima Adicional</td>
                                        <td>Cajas</td>
                                        <td>Ver Compra</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="reimpReporte.jsp?F_FolRemi=<%=rset.getString("F_FolRemi")%>&F_OrdCom=<%=rset.getString("F_OrdCom")%>&fol_gnkl=<%=rset.getString(1)%>&fecha=<%=rset.getString(4)%>" target="_blank" class="btn btn-block btn-success">Imprimir</a>
                                        </td>
                                        <td>
                                            <a href="reimp_marbete.jsp?F_FolRemi=<%=rset.getString("F_FolRemi")%>&F_OrdCom=<%=rset.getString("F_OrdCom")%>&fol_gnkl=<%=rset.getString(1)%>&Ban=1" target="_blank" class="btn btn-block btn-success">Imprimir</a>
                                        </td>
                                        <td>
                                            <a href="reimp_marbete.jsp?F_FolRemi=<%=rset.getString("F_FolRemi")%>&F_OrdCom=<%=rset.getString("F_OrdCom")%>&fol_gnkl=<%=rset.getString(1)%>&Ban=2" target="_blank" class="btn btn-block btn-success">Imprimir</a>
                                        </td>
                                        <td>
                                            <a href="reimp_marbeteCajas.jsp?F_FolRemi=<%=rset.getString("F_FolRemi")%>&F_OrdCom=<%=rset.getString("F_OrdCom")%>&fol_gnkl=<%=rset.getString(1)%>&Ban=2" target="_blank" class="btn btn-block btn-success">Imprimir</a>
                                        </td>
                                        <td>
                                            <form action="verCompra.jsp" method="post">
                                                ...
                                                <button class="btn btn-block btn-success">Ver Compra</button>
                                            </form>
                                        </td>
