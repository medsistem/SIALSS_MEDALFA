...
<%
    ...
    try {
        con.conectar();
        ResultSet rset = con.consulta("select F_ClaPro, F_Lote, F_FecCad, F_FecFab, F_Marca, F_Cb, F_Cajas, F_Pz, F_Tarimas, F_Resto, F_TarimasI, F_CajasI, F_FolRemi, F_Provee from tb_compratempisem where F_IdCom = '" + ((String) sesion.getAttribute("id")) + "' ");
        while (rset.next()) {
