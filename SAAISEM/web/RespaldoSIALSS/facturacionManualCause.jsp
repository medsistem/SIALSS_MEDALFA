...
<%
    ...
    String ClaCli = "", FechaEnt = "", ClaPro = "", DesPro = "",Cause="";
    ...
    <body>
        <div class="container">
            ...
            <%                
                ...
                if (F_IndGlobal == null) {
            %>
            <form action="facturacionManualCause.jsp" method="post">
            ...
            <form action="FacturacionManual" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" name="Cause" id="Cause">
                            <option value="">-Seleccione Cause-</option>
                        <%
                            try {
                                con.conectar();
                                ResultSet rset = con.consulta("SELECT C.F_Cause, T.F_Cause FROM tb_catalogoprecios C INNER JOIN tb_tipocause T ON C.F_Cause = T.F_Id WHERE C.F_Proyecto = '"+Proyecto+"' AND C.F_Cause != 0 GROUP BY C.F_Cause;");
                                while (rset.next()) {
                        %>
                        <option value="<%=rset.getString(1)%>"
                                <%
                                        if (rset.getString(1).equals(Cause)) {
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <button class="btn btn-success btn-block" name="accion" value="btnClaveCause" id="btnClaveCause" onclick="return validaUni();">Buscar</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <button class="btn btn-block btn-success" name="accion" value="SeleccionaLoteCause" onclick="return validaSeleccionar();">Seleccionar</button>
                            </div>
                        </div>
                ...
                <table class="table table-condensed table-striped table-bordered table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-block btn-success" name="accionEliminarCause" value="<%=rset.getString("F_Id")%>" onclick="return confirm('Seguro que desea eliminar esta clave?')"><span class="glyphicon glyphicon-remove"></span></button>
                        </td>
                    </tr>
                    <%
                            }
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <button class="btn btn-block btn-success" name="accion" value="CancelarFacturaCause" onclick="return confirm('Seguro de CANCELAR la Factura?')">Cancelar Factura</button>
                    </div>
                </div>
    ...
    ================================================== -->
        ...
        <script>
                            ...
                            function validaUni() {
                                ...
                                if (Cause === "") {
                                    alert('Seleccione Tipo de Cause');
                                    return false;
                                }
