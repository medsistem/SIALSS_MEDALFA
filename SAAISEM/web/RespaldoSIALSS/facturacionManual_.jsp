    ...
    <body>
        <div class="container">
            ...
            <form action="FacturacionManual" method="post">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <button class="btn btn-success btn-block" name="accion" value="btnClave" id="btnClave" onclick="return validaUni();">Buscar</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <button class="btn btn-block btn-success" name="accion" value="ConfirmarFactura" onclick="return confirm('Seguro de confirmar la Factura?')">Confirmar Factura</button>
                    </div>
                    <div class="col-sm-6">
