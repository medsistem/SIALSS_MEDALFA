...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body ">
                    <form class="form-horizontal" role="form" name="formulario1" id="formulario1" method="post" action="facturaAtomaticaAnestesia.jsp">
        ...
        <script src="js/facturajs/AutomaticaFacturacionAnestesia.js"></script>
