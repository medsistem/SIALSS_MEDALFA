                            ...
                            <tbody>
                                <%
                                    try {
                                        con.conectar();
                                        try {
                                            ResultSet rset = con.consulta("SELECT c.F_ClaDoc, c.F_FolRemi, c.F_OrdCom, c.F_FecApl, c.F_User, p.F_NomPro FROM tb_compra c INNER JOIN tb_proveedor p ON c.F_ProVee = p.F_ClaProve INNER JOIN tb_usuario u ON c.F_User = u.F_Usu WHERE u.F_TipUsu = 8 GROUP BY F_OrdCom, F_FolRemi;");
                                            while (rset.next()) {
                                %>
                                <tr>
                                    ...
                                    <td>
                                        <form action="reimp_marbete.jsp" target="_blank">
                                            ...
                                            <input class="hidden" name="F_OrdCom" value="<%=rset.getString("F_OrdCom")%>">
                                            <input class="hidden" name="fol_gnkl" value="<%=rset.getString(1)%>">
                                            <input class="hidden" name="Ban" value="1">
                                            <button class="btn btn-block btn-success">Imprimir</button>
                                        </form>
                                    </td>
                                    <td>
                                        <form action="reimp_marbete.jsp" target="_blank">
                                            ...
                                            <input class="hidden" name="F_OrdCom" value="<%=rset.getString("F_OrdCom")%>">
                                            <input class="hidden" name="fol_gnkl" value="<%=rset.getString(1)%>">
                                            <input class="hidden" name="Ban" value="2">
                                            <button class="btn btn-block btn-success">Imprimir</button>
                                        </form>
                                    </td>
                                    <td>
