...
<%
    ...
    String usua = "", tipo = "", IdUsu = "", horEnt = "", nombre;
...
<html>
    ...
    <body onload="focusLocus();">
        <div class="container">
            ...
            <br/>
            <div class="row">
                <form method="post" action="verFoliosMedalfaAud.jsp">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" name="Proveedor" id="Proveedor" onchange="SelectProve(this.form);
                                ...
                                <%
                                        ...
                                        Logger.getLogger("verFoliosMedalfaAud.jsp").log(Level.SEVERE, null, e);
                                    } finally {
                                        try {
                                            con.cierraConexion();
                                        } catch (Exception e) {
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" name="Usuario" id="Usuario" onchange="">
                                ...
                                <%
                                    try {
                                        con.conectar();
                                        ResultSet rset = con.consulta("SELECT u.F_IdUsu, u.F_Usu FROM tb_usuario u, tb_pedidoisem2017 p WHERE  u.F_IdUsu = p.F_IdUsu GROUP BY F_IdUsu;");
                                        while (rset.next()) {
                                %>
                                <option value="<%=rset.getString(1)%>" ><%=rset.getString(2)%></option>
                                <%
                        ...
                        <tbody>
                            <%
                                ...
                                try {
                                    ...
                                    if (!(Proveedor.equals(""))) {
                                        rset = con.consulta("SELECT o.F_NoCompra, u.F_Usu, p.F_NomPro, DATE_FORMAT(o.F_FecSur, '%d/%m/%Y') F_FecSur, F_HorSur, F_Fecha FROM tb_pedidoisem2017 o, tb_proveedor p, tb_usuario u WHERE u.F_IdUsu = o.F_IdUsu AND o.F_Provee = p.F_ClaProve and o.F_Provee = '" + request.getParameter("Proveedor") + "' AND F_StsPed < 3 group by o.F_NoCompra;");

                                    } else if (!(fecha.equals(""))) {
                                        rset = con.consulta("SELECT o.F_NoCompra, u.F_Usu, p.F_NomPro, DATE_FORMAT(o.F_FecSur, '%d/%m/%Y') F_FecSur, F_HorSur, F_Fecha FROM tb_pedidoisem2017 o, tb_proveedor p, tb_usuario u WHERE u.F_IdUsu = o.F_IdUsu AND o.F_Provee = p.F_ClaProve and o.F_FecSur =  '" + fecha + "%' AND F_StsPed < 3 group by o.F_NoCompra;");

                                    } else if (!(Usuario.equals(""))) {
                                        rset = con.consulta("SELECT o.F_NoCompra, u.F_Usu, p.F_NomPro, DATE_FORMAT(o.F_FecSur, '%d/%m/%Y') F_FecSur, F_HorSur, F_Fecha FROM tb_pedidoisem2017 o, tb_proveedor p, tb_usuario u WHERE u.F_IdUsu = o.F_IdUsu AND o.F_Provee = p.F_ClaProve and o.F_IdUsu = '" + request.getParameter("Usuario") + "' AND F_StsPed < 3 group by o.F_NoCompra");
                                    }
                ...
                <div class="panel-info">
                    ...
                    <div class="panel-body ">
                        <%                
                            try {
                                con.conectar();
                                ResultSet rset = con.consulta("SELECT o.F_NoCompra, p.F_NomPro, DATE_FORMAT(o.F_FecSur, '%d/%m/%Y'), F_HorSur, F_Usu, F_StsPed, rec.F_Recibido, o.F_Zona, o.F_Tipo, DATE_FORMAT(o.F_Fecha, '%d/%m/%Y') FROM tb_pedidoisem2017 o INNER JOIN tb_proveedor p ON o.F_Provee = p.F_ClaProve INNER JOIN tb_usuariocompra u ON u.F_IdUsu = o.F_IdUsu INNER JOIN ( SELECT F_NoCompra, SUM(F_Recibido) AS F_Recibido FROM tb_pedidoisem2017 o WHERE F_NoCompra = '" + NoCompra + "' ) rec ON o.F_NoCompra = rec.F_NoCompra WHERE o.F_NoCompra = '" + NoCompra + "' AND F_StsPed < 3 GROUP BY o.F_NoCompra;");
                                while (rset.next()) {
                        %>
                        ...
                        <table class="table table-bordered table-condensed table-striped" id="datostableoc">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    %>
                                    <td>
                                        <input  id="cantidadM_<%=rset.getString(8)%>" name="cantidadM_<%=rset.getString(8)%>" type="number" min="0" max="4" /></td>
                                    <td>
