...
<%
    ...
    String F_IndTransfer = (String) sesion.getAttribute("F_IndTransfer");
    String usua = "", tipo = "";
    ...
    try {
        ...
        try {
            ...
            if (rset.getString("F_StsFact").equals("3")) {
                sesion.setAttribute("F_IndTransfer", rset.getString(1));
                F_IndTransfer = (String) sesion.getAttribute("F_IndTransfer");
        ...
        if (request.getParameter("accion").equals("nuevoFolio")) {
            sesion.setAttribute("F_IndTransfer", fact.dameIndTranfer() + "");
            F_IndTransfer = (String) sesion.getAttribute("F_IndTransfer");
        }
        con.cierraConexion();
    } catch (Exception e) {
    ...
    <body onLoad="foco();">
        <div class="container">
            ...
            <form action="../FacturacionManual" method="post" name="formulario1" id="formulario1">
                <h4 class="text-muted">Folio: <%=F_IndTransfer%></h4>
                <div class="row">
                    <div class="col-sm-1">
                        <h4>Unidad:</h4>
                    </div>
                    <div class="col-sm-5">
                        <select class="form-control" name="ClaCli" id="ClaCli">
                            ...
                            <%
                                try {
                                    con.conectar();
                                    ResultSet rset = con.consulta("SELECT F_IdCon,CONCAT('[',F_IdCon,']  ',F_DesCon) AS F_DesCon FROM tb_coninv WHERE  F_IdCon IN (75,76,77,78,79,80,81,82);");
                                    while (rset.next()) {
                            %>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <button class="btn btn-success btn-block" name="accion" value="btnClaveT" id="btnClaveT" onclick="return validaBuscar();">Buscar</button>
                            </div>
                        </div>
                    </div>
                ...
                <table class="table table-condensed table-striped table-bordered table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-block btn-success" name="accionEliminarTrans" value="<%=rset.getString("F_Id")%>" onclick="return confirm('Seguro que desea eliminar esta clave?')"><span class="glyphicon glyphicon-remove"></span></button>
                        </td>
                    </tr>
                    <%
                            }
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <button class="btn btn-block btn-success" name="accion" value="ConfirmarTransferencia" onclick="return validaRemision()">Confirmar Transferencia</button>
                    </div>
                    <div class="col-sm-6">
                        <button class="btn btn-block btn-success" name="accion" value="CancelarTransferencia" onclick="return confirm('Seguro de CANCELAR la Factura?')">Cancelar Transferencia</button>
                    </div>
                </div>
