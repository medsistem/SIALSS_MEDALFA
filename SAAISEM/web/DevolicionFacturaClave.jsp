...
<%
    ...
    if (sesion.getAttribute("nombre") != null) {
        ...
        if (!tipo.equals("1") && !username.equals("mjgalindo") && !username.equals("ASeguraF") && !username.equals("FSalazarLo") && !username.equals("Francisco") && !username.equals("carolina") && !username.equals("LuisJ") && !username.equals("MariaC") && !username.equals("GenaroC") && !username.equals("HeidiA")) {
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <h4 class="col-sm-6">Devoluciones de Facturas por Clave</h4>
            </div>
            <form name="forma1" id="forma1" action="DevolucionesFacturas" method="post">
                <c:forEach items="${DatosUnidad}" var="detalle">
                    <div class="row">
                        ...
                        <input class="form-control" name="FolioC" id="FolioC" type="hidden" value="${detalle.folio}">
                        <label class="col-sm-1">Unidad:</label>
                        <div class="col-sm-5"><c:out value="${detalle.claveuni}" /> - <c:out value="${detalle.unidad}" /> </div>
                        <input class="form-control" name="UnidadC" id="UnidadC" type="hidden" value="${detalle.unidad}">
                        <input class="form-control" name="ProyectoC" id="ProyectoC" type="hidden" value="${detalle.proyecto}">
                ...
                <div class="panel-footer">
                    <div class="row">
                        <h4 class="control-label col-sm-1" for="fecha_ini">Clave: </h4>
                        <div class="col-sm-2">                            
                            <input name="Clave" id="Clave" class="form-control" required="" />
                        </div>
                        <div class="col-sm-2">
                            <button class="btn btn-block btn-info" name="Accion" value="btnClave" >MOSTRAR CLAVE&nbsp;<label class="glyphicon glyphicon-search"></label></button>
                        </div>
                        <% if (tipo.equals("7")) { %>
                        <div>                       
                            <h4 class="control-label col-sm-2" for="ubicaDevFact">Ubicación destino:</h4>       
                            <div class="col-sm-3">
                        ...
                        <div style="width:100%; height:400px; overflow:auto;">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <td>                                            
                                        <button class="btn btn-block btn-success" name="Accion" id="btnEliminarClave${detalle2.iddocumento}" type="button" value="btnEliminar"><span class="glyphicon glyphicon-trash"></span></button>                                                                                    
                                    </td>
                ...
                <c:forEach items="${DatosUnidad}" var="detalle">
                    <div class="row">
                        ...
                        <br />
                        Observaciones:<textarea cols="100" rows="2" class="form-control" name="Obs" id="Obs"></textarea>
                    </div>
                </c:forEach>
            </form>            
            <!--Modal-->
                        ...
                        <div class="modal-content">
                            ...
                            <form name="Devolucion" action="DevolucionesFacturas" method="Post">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-default" name="Accion" value="btnModificarClave" onclick="validarGuardar()">Guardar</button>
