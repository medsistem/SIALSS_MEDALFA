                            ...
                            <table class="table table-bordered table-striped" id="datosCompras">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Proveedor</th>
                                        <th>Compra</th>
                                        <th>Tarimas Completas</th>
                                        <th>Tarima Adicional</th>
                                        <th>Cajas</th>
                                        <th>Ver Compra</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="reimp_marbete.jsp?F_FolRemi=<%=rset.getString("F_FolRemi")%>&F_OrdCom=<%=rset.getString("F_OrdCom")%>&fol_gnkl=<%=rset.getString(1)%>&Ban=1" target="_blank" class="btn btn-block btn-danger">TARIMAS C</a>
                                        </td>
                                        <td>
                                            <a href="reimp_marbete.jsp?F_FolRemi=<%=rset.getString("F_FolRemi")%>&F_OrdCom=<%=rset.getString("F_OrdCom")%>&fol_gnkl=<%=rset.getString(1)%>&Ban=2" target="_blank" class="btn btn-block btn-success">TARIMAS A</a>
                                        </td>
                                        <td>
                                            <a href="reimp_marbeteCajas.jsp?F_FolRemi=<%=rset.getString("F_FolRemi")%>&F_OrdCom=<%=rset.getString("F_OrdCom")%>&fol_gnkl=<%=rset.getString(1)%>&Ban=2" target="_blank" class="btn btn-block btn-warning">CAJAS</a>
                                        </td>
                                         </form>
                                        <td>
