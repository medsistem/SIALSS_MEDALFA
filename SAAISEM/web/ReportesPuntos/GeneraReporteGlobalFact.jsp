        ...
        <div class="container">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Generar Reportes Globales de Facturación</h3>
                </div>
                
                <form action="../ReporteGlobal" method="post">
                        <div class="panel-footer">
                            <div class="row">                                    
                                ...
                                <div class="col-sm-3">
                                    <input type="radio" id="radio" name="radio" checked="true" value="1" > Global
                                    <input type="radio" id="radio" name="radio" value="2"> Global C/L
                                    <input type="radio" id="radio" name="radio" value="3"> Exportar
                                </div>                                
                                <div class="col-sm-2">
                                    <input type="radio" id="radio2" name="radio2" checked="true" value="1" > Rurales
                                    <input type="radio" id="radio2" name="radio2" value="2"> Farmacia
                                </div>
                            </div>                            
                        </div>     
