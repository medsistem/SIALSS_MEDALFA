...
<% /*Parametros para realizar la conexión*/
    ...
    String F_FecSur = request.getParameter("Fecha");
    ...
    try {
        ...
        String FechaMax = "", F_ClaPro = "";
        int No = 0, Origen = 0, PzFacturado = 0, FacturaPro = 0, Requerido = 0, PzFacturado2 = 0, FacturaPro2 = 0, Requerido2 = 0;
        ...
        ResultSet rset = con.consulta("select F_ClaPro,F_DesPro,F_Origen,F_Cp7  from tb_medica WHERE F_N" + Nivel + "='1' AND F_StsPro='A' order by F_ClaPro+0");
        while (rset.next()) {
            No = No + 1;
            String color = "";
            int cantSolPrev = 0;
            ...
            ResultSet Requeri = con.consulta("SELECT SUM(F_Cantidad) AS F_Cantidad FROM tb_requerimientonivel r WHERE r.F_ClaCli='" + ClaUni + "' AND r.F_NoReq='" + folio_gnk + "' AND F_ClaPro='" + rset.getString(1) + "'");
            if (Requeri.next()) {
                Requerido = Requeri.getInt(1);
            }

            con.insertar("INSERT INTO tb_reqimprime VALUES('" + F_DesJurIS + "','" + F_DesMunIS + "','" + F_DesLocIS + "','" + F_DesUniIS + "','" + Nucleo + "','" + F_Ruta + "','" + No + "','" + F_ClaPro + "','" + rset.getString(2) + "','" + FacturaPro + "','" + PzFacturado + "','" + Requerido + "','" + DesOrigen + "','" + ClaUni + "','" + folio_gnk + "','" + F_FecSur + "',0)");

            FacturaPro2 = FacturaPro2 + FacturaPro;
            PzFacturado2 = PzFacturado2 + PzFacturado;
            Requerido2 = Requerido2 + Requerido;
        ...
        con.insertar("INSERT INTO tb_reqimprime VALUES('" + F_DesJurIS + "','" + F_DesMunIS + "','" + F_DesLocIS + "','" + F_DesUniIS + "','" + Nucleo + "','" + F_Ruta + "','','','','" + FacturaPro2 + "','" + PzFacturado2 + "','" + Requerido2 + "','" + DesOrigen + "','" + ClaUni + "','" + folio_gnk + "','" + F_FecSur + "',0)");
    ...
    File reportFile = new File(application.getRealPath("/ReportesPuntos/RequerimientosU.jasper"));
