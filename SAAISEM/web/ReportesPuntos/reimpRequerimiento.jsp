...
<% /*Parametros para realizar la conexión*/
    ...
    try{
        ...
        String FechaMax="",F_ClaPro="",F_FecSur="";
        ...
        while (rset.next()) {            
            ...
            ResultSet Requeri = Req.consulta("SELECT DATE_FORMAT(F_FecSur,'%d/%m/%Y') AS F_FecSur,F_Cant FROM tb_requerimientos r INNER JOIN tb_detrequerimiento d on r.F_IdReq=d.F_IdReq WHERE r.F_ClaCli='"+ClaUni+"' AND r.F_IdReq='"+folio_gnk+"' AND F_ClaPro='"+rset.getString(1)+"'");
            if(Requeri.next()){
                F_FecSur = Requeri.getString(1);
                Requerido = Requeri.getInt(2);
            }
