...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h2>Agregar Clave al folio</h2>
                </div>
            </div>
            <hr/>
            <%                if (F_IndGlobal == null) {
            %>
            <form action="facturacionManualFolio.jsp" method="post">
            ...
            <form action="FacturacionManual" method="post">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <button class="btn btn-success btn-block" name="accion" value="btnClaveFOLIO" id="btnClaveFOLIO" onclick="return validaUni();">Buscar</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <input class="form-control" name="Cantidad" typr?="number" id="Cantidad" onKeyPress="return justNumbers(event);"/>
                            </div>
                            <div class="col-sm-2">
                                <button class="btn btn-block btn-success" name="accion" value="SeleccionaLoteFOLIO" onclick="return validaSeleccionar();">Seleccionar</button>
                            </div>
                            <div class="col-sm-2">
                                <a class="btn btn-block btn-default" href="ModificarFolio?Accion=btnMostrar&Folio=<%=F_IndGlobal%>">Regresar</a>
                            </div>
                        </div>
                ...
                <table class="table table-condensed table-striped table-bordered table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-block btn-success" name="accionEliminarFOLIO" value="<%=rset.getString("F_Id")%>" onclick="return confirm('Seguro que desea eliminar esta clave?')"><span class="glyphicon glyphicon-remove"></span></button>
                        </td>
                    </tr>
                    <%
                            }
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <button class="btn btn-block btn-danger" name="accion" value="CancelarFacturaFOLIO" onclick="return confirm('Seguro de CANCELAR la Factura?')">Cancelar Factura</button>
                    </div>
                </div>
