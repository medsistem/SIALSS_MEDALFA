...
<%
    ...
    String F_IndGlobal = (String) sesion.getAttribute("F_IndGlobalTP");
    ...
    try {
        ClaCli = (String) sesion.getAttribute("ClaCliFMTP");
        ClaPro = (String) sesion.getAttribute("ClaProFMTP");
        DesPro = (String) sesion.getAttribute("DesProFMTP");
    } catch (Exception e) {
    ...
    try {
        ...
        if (rset.getString("F_StsFact").equals("3") && rset.getString("F_User").equals(usua)) {
            sesion.setAttribute("F_IndGlobalTP", rset.getString(1));
            F_IndGlobal = (String) sesion.getAttribute("F_IndGlobalTP");
            ClaCli = rset.getString("F_ClaCli");
            sesion.setAttribute("ClaCliFMTP", ClaCli);
    ...
    try {
        if (request.getParameter("accion").equals("nuevoFolio")) {
            sesion.setAttribute("F_IndGlobalTP", fact.dameIndGlobalTProducto() + "");
            F_IndGlobal = (String) sesion.getAttribute("F_IndGlobalTP");
        }
    } catch (Exception e) {
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <%                if (F_IndGlobal == null) {
            %>
            <form action="transferproducproyecto.jsp" method="post">
                <button class="btn btn-block btn-success" name="accion" value="nuevoFolio">Nueva Tranferencia</button>
            </form>
            <%
            } else {
            %>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <button class="btn btn-success btn-block" name="accion" value="btnClaveTP" id="btnClaveTP" onclick="return validaUni();">Buscar</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <button class="btn btn-block btn-success" name="accion" value="SeleccionaLoteTP" onclick="return validaSeleccionar();">Seleccionar</button>
                            </div>
                        </div>
