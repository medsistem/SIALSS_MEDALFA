...
<% /*Parametros para realizar la conexión*/
    ...
    String folio_gnk = request.getParameter("fol_gnkl");
     String folio_ref = request.getParameter("fol_ref");
    Connection conexion;
    Class.forName("org.mariadb.jdbc.Driver").newInstance();
    conexion = con.getConn();
    /*Establecemos la ruta del reporte*/
    File reportFile = new File(application.getRealPath("/reportes/Admindevolucion.jasper"));
    /* No enviamos parámetros porque nuestro reporte no los necesita asi que escriba 
     cualquier cadena de texto ya que solo seguiremos el formato del método runReportToPdf*/
    Map parameters = new HashMap();
    parameters.put("Folfact", folio_gnk);
    parameters.put("Folref", folio_ref);
