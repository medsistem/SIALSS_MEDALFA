...
<%
    ...
    String usua = "", CveUni = "", TipoUnidad = "", TipoUsuario = "", UnidadSelect = "", Tipo = "", Valida = "", tipo = "";
    int Cantidad = 0;
        ...
        <div class="container">
            ...
            <div>
                <form action="Capturar" method="post" name="formulario" id="formulario">
                    ...
                    <br/>
                    <div>
                        <button class="btn btn-success btn-block" type="button" name="BtnSugerencia" id="BtnSugerencia">Registrar Sugerencia</button>
                    </div>
                </form>
            </div>
        </div>
