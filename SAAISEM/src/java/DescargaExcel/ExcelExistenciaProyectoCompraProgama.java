      ...
      protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (Proyecto.equals("0")) {
                ...
                switch (Consulta) {
                    case "1":
                        qry = "SELECT P.F_DesProy, L.F_ClaPro, M.F_DesPro, L.F_ClaLot, DATE_FORMAT(L.F_FecCad, '%d/%m/%Y') AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri, L.F_Ubica, M.F_ClaProSS,M.F_NomGen,M.F_FormaFarm,M.F_Concentracion,M.F_DesProEsp FROM tb_lote L INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id  WHERE L.F_ExiLot > 0 " + AND + "  "+AND2+"  AND M.F_StsPro = 'A' GROUP BY L.F_ClaPro, L.F_Proyecto;";
                        break;
                    case "2":
                ...
                switch (Consulta) {
                    case "1":
                        qry = "SELECT P.F_DesProy, L.F_ClaPro, M.F_DesPro, L.F_ClaLot, DATE_FORMAT(L.F_FecCad, '%d/%m/%Y') AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri, L.F_Ubica , M.F_ClaProSS,M.F_NomGen,M.F_FormaFarm,M.F_Concentracion,M.F_DesProEsp FROM tb_lote L INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id WHERE L.F_Proyecto = '" + Proyecto + "' AND L.F_ExiLot>0 " + AND + "   "+AND2+" AND L.F_FecCad > CURDATE()  AND M.F_StsPro = 'A' GROUP BY L.F_ClaPro, L.F_Proyecto;";
                        break;
                    case "2":
                        qry = "SELECT P.F_DesProy, L.F_ClaPro, M.F_DesPro, L.F_ClaLot, DATE_FORMAT(L.F_FecCad, '%d/%m/%Y') AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri, L.F_Ubica, M.F_ClaProSS,M.F_NomGen,M.F_FormaFarm,M.F_Concentracion,M.F_DesProEsp FROM tb_lote L INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id WHERE L.F_Proyecto = '" + Proyecto + "' AND L.F_ExiLot>0 " + AND + "  "+AND2+" AND L.F_FecCad > CURDATE()  AND M.F_StsPro = 'A' GROUP BY L.F_ClaPro, L.F_ClaLot, L.F_FecCad, L.F_Origen, L.F_Proyecto;";
                        break;
