...
/**
 * Exportar catálogo isem farmacia
 *
 * @author MEDALFA SOFTWARE
 * @version 1.40
 */
public class ExporTxtIsFarm extends HttpServlet {

    ExporTxtFarm TxT = new ExporTxtFarm();
    ExporTxtCancelFarm Cancel = new ExporTxtCancelFarm();
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<script>window.location='CatalogoIsem/TxtFar.jsp'</script>");
    }
