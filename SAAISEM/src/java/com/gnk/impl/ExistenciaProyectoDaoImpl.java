...
public class ExistenciaProyectoDaoImpl implements ExistenciaProyectoDao {
   ...
   public static String ExistenciaProyectoGlobalFonsabi = "SELECT P.F_DesProy, L.F_ClaPro, SUBSTR(M.F_DesPro,1,40) AS F_DesPro, L.F_ClaLot, DATE_FORMAT(L.F_FecCad, '%d/%m/%Y') AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri, L.F_Ubica,M.F_PrePro,tb_proveedor.F_ClaProve,tb_proveedor.F_NomPro, b.Nombre_Bodega as lugar, '' AS F_OrdenSuministro, '' AS F_FolRemi, '' AS OC, C.F_FuenteFinanza, '' AS F_IdLote, M.F_NomGen  FROM tb_lote L INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id INNER JOIN tb_proveedor ON tb_proveedor.F_ClaProve = L.F_ClaPrv LEFT JOIN tb_compra C ON C.F_Lote = L.F_FolLot AND C.F_ClaPro = L.F_ClaPro LEFT JOIN tb_ubica as u ON u.F_ClaUbi=L.F_Ubica LEFT JOIN tb_bodegas AS b ON b.Id_Bodega = u.Id_Bodega WHERE L.F_Proyecto = ? AND L.F_ExiLot > 0 AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995') AND L.F_Origen = '19' AND u.Estatus=1 AND b.Estatus=1 GROUP BY L.F_ClaPro, L.F_Proyecto;";
    ...
    public static String ContarClaveProyecto = "SELECT COUNT(DISTINCT(F_ClaPro)) AS CONTAR FROM tb_lote L WHERE L.F_Proyecto = ? AND L.F_ExiLot > 0 AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995');";

    public static String ContarClaveTodos = "SELECT COUNT(DISTINCT(F_ClaPro)) AS CONTAR FROM tb_lote L WHERE L.F_ExiLot > 0 AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995');";

    public static String ContarClaveTodosCosulta = "SELECT COUNT(DISTINCT(F_ClaPro)) AS CONTAR FROM tb_lote L WHERE L.F_ExiLot > 0 AND L.F_Proyecto IN (%s) AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995');";

    public static String ExistenciaProyectoTodosGlobal = "SELECT P.F_DesProy, L.F_ClaPro, SUBSTR(M.F_DesPro,1,40) AS F_DesPro, L.F_ClaLot, DATE_FORMAT(L.F_FecCad, '%d/%m/%Y') AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri, L.F_Ubica,M.F_PrePro,tb_proveedor.F_ClaProve,tb_proveedor.F_NomPro,b.Nombre_Bodega as lugar FROM tb_lote L INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id INNER JOIN tb_proveedor ON tb_proveedor.F_ClaProve = L.F_ClaPrv LEFT JOIN tb_ubica as u ON u.F_ClaUbi=L.F_Ubica LEFT JOIN tb_bodegas AS b ON b.Id_Bodega = u.Id_Bodega WHERE L.F_ExiLot>0 AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995') AND u.Estatus=1 AND b.Estatus=1 GROUP BY L.F_ClaPro, L.F_Proyecto;";
    ...
    public static String ExistenciaProyectoTodosClientes = "SELECT P.F_DesProy, L.F_ClaPro, SUBSTR(M.F_DesPro,1,40) AS F_DesPro, L.F_ClaLot, DATE_FORMAT(L.F_FecCad, '%d/%m/%Y') AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri FROM tb_lote L INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id WHERE L.F_ExiLot>0 AND L.F_Proyecto IN (%s) AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995')  AND L.F_Ubica NOT LIKE '%AT%' GROUP BY L.F_ClaPro, L.F_ClaLot, L.F_FecCad, L.F_Origen, L.F_Proyecto;";

    public static String ExistenciaProyectoConsulta = "SELECT P.F_DesProy, L.F_ClaPro, SUBSTR(M.F_DesPro,1,40) AS F_DesPro, L.F_ClaLot, DATE_FORMAT(L.F_FecCad, '%d/%m/%Y') AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri FROM tb_lote L INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id WHERE L.F_ExiLot>0 AND L.F_Proyecto IN ( %d ) AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995')  GROUP BY L.F_ClaPro, L.F_ClaLot, L.F_FecCad, L.F_Origen, L.F_Proyecto;";
...
public static String BuscaclavePrograma = "SELECT F_ClaPro FROM tb_medicaprograma;";
    ...
    public static String ExistenciaProyectoCompraLotePrograma = "SELECT P.F_DesProy, M.F_ClaPro, SUBSTR(M.F_DesPro,1,40) AS F_DesPro, L.F_ClaLot, L.F_FecCad AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri, L.F_Ubica , CASE WHEN L.F_Ubica = 'CUARENTENA' THEN 'NO DISPONIBLE' ELSE 'DISPONIBLE' END  AS  Estatus, c.F_OrdenSuministro as suministro, M.F_NomGen, M.F_FormaFarm, M.F_Concentracion, IFNULL(c.F_FuenteFinanza,'') as FuenteFinanza FROM tb_lote L LEFT JOIN (SELECT F_Lote,GROUP_CONCAT(F_OrdenSuministro  SEPARATOR' // ') as F_OrdenSuministro,F_FuenteFinanza  FROM tb_compra where F_OrdenSuministro IS NOT NULL group by F_Lote) c on L.F_FolLot = c.F_Lote INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id WHERE L.F_Proyecto = ? AND L.F_ExiLot > 0  AND F_Ubica NOT IN (%s) AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995') AND L.F_ClaPro IN (%s) AND L.F_FecCad > CURDATE() AND M.F_StsPro = 'A' GROUP BY L.F_ClaPro, L.F_ClaLot, L.F_FecCad, L.F_Origen, L.F_Proyecto;";
     // public static String ExistenciaProyectoCompraGlobalPrograma = "SELECT P.F_DesProy, M.F_ClaPro, SUBSTR(M.F_DesPro,1,40) AS F_DesPro, L.F_ClaLot, L.F_FecCad AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri, L.F_Ubica, CASE WHEN L.F_Ubica = 'CUARENTENA' THEN 'NO DISPONIBLE' ELSE 'DISPONIBLE' END  AS  Estatus, M.F_PrePro FROM tb_lote L INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id WHERE L.F_Proyecto = ? AND L.F_ExiLot > 0  AND F_Ubica NOT IN (%s) AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995') AND L.F_ClaPro IN (%s) AND L.F_FecCad > CURDATE()  GROUP BY L.F_ClaPro, L.F_Proyecto;";
   //   public static String ExistenciaProyectoCompraLotePrograma = "SELECT P.F_DesProy, M.F_ClaPro, SUBSTR(M.F_DesPro,1,40) AS F_DesPro, L.F_ClaLot, L.F_FecCad AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri, L.F_Ubica , CASE WHEN L.F_Ubica = 'CUARENTENA' THEN 'NO DISPONIBLE' ELSE 'DISPONIBLE' END  AS  Estatus, M.F_PrePro FROM tb_lote L INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id WHERE L.F_Proyecto = ? AND L.F_ExiLot > 0  AND F_Ubica NOT IN (%s) AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995') AND L.F_ClaPro IN (%s) AND L.F_FecCad > CURDATE()  GROUP BY L.F_ClaPro, L.F_ClaLot, L.F_FecCad, L.F_Origen, L.F_Proyecto;";


    public static String ExistenciaProyectoCompraGlobal = "SELECT P.F_DesProy, M.F_ClaProSS, SUBSTR(M.F_DesPro,1,40) AS F_DesPro, L.F_ClaLot, L.F_FecCad AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri, L.F_Ubica, CASE WHEN L.F_Ubica = 'CUARENTENA' THEN 'NO DISPONIBLE' ELSE 'DISPONIBLE' END  AS  Estatus, c.F_OrdenSuministro as suministro, M.F_NomGen, M.F_FormaFarm, M.F_Concentracion, IFNULL(c.F_FuenteFinanza,'') as FuenteFinanza, M.F_PrePro FROM tb_lote L LEFT JOIN (SELECT F_Lote, F_OrdenSuministro,F_FuenteFinanza  FROM tb_compra where F_OrdenSuministro IS NOT NULL group by F_Lote) c on L.F_FolLot = c.F_Lote INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id WHERE L.F_Proyecto = ? AND L.F_ExiLot > 0  AND F_Ubica NOT IN (%s) AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995') AND L.F_FecCad > CURDATE() AND L.F_Origen <> '19' AND M.F_StsPro = 'A' GROUP BY L.F_ClaPro, L.F_Proyecto;";
...
//    public static String ContarClaveProyectoCompraDis = "SELECT COUNT(DISTINCT(F_ClaPro)) AS CONTAR FROM tb_lote L WHERE L.F_Proyecto = ?  AND L.F_ExiLot > 0 AND F_Ubica NOT IN (%s) AND L.F_ClaPro NOT IN ('9999', '9998');";
    public static String ContarClaveProyectoCompraDis = "SELECT COUNT(DISTINCT(F_ClaPro)) AS CONTAR FROM v_existencias L WHERE L.F_ExiLot > 0 AND L.F_FecCad > DATE_ADD(CURDATE(),INTERVAL 7 DAY) AND F_Ubica NOT IN (%s) AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995');";

    public static String ContarClaveTodosCompra = "SELECT COUNT(DISTINCT(F_ClaPro)) AS CONTAR FROM tb_lote L WHERE L.F_ExiLot > 0 AND F_Ubica NOT IN ('CADUCADOS', 'PROXACADUCAR', 'MERMA', 'CROSSDOCKMORELIA', 'INGRESOS_V', 'CUARENTENA',  'ATI','NUEVA', 'AT','duplicado','CADUCADOSFARMACIA') AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995');";

    public static String ExistenciaProyectoTodosCompraGlobal = "SELECT P.F_DesProy, M.F_ClaProSS, SUBSTR(M.F_DesPro,1,40) AS F_DesPro, L.F_ClaLot, L.F_FecCad AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri, L.F_Ubica, CASE  WHEN L.F_Ubica = 'CUARENTENA' THEN 'NO DISPONIBLE' ELSE 'DISPONIBLE' END  AS  ESTATUS, c.F_OrdenSuministro as suministro, M.F_NomGen, M.F_FormaFarm, M.F_Concentracion, IFNULL(c.F_FuenteFinanza,'') as FuenteFinanza, M.F_PrePro FROM tb_lote L LEFT JOIN (SELECT F_Lote, F_OrdenSuministro,F_FuenteFinanza  FROM tb_compra where F_OrdenSuministro IS NOT NULL group by F_Lote) c on L.F_FolLot = c.F_Lote INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id WHERE L.F_ExiLot>0 AND L.F_Ubica NOT IN (%s) AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995') AND M.F_StsPro = 'A'  GROUP BY L.F_ClaPro, L.F_Proyecto;";
 ...
 //SOLUGLOB
    public static String ExistenciaSoluglob = "SELECT P.F_DesProy, M.F_ClaProSS, SUBSTR(M.F_DesPro,1,40) AS F_DesPro, L.F_ClaLot, L.F_FecCad AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri ,L.F_Ubica , CASE WHEN L.F_Ubica = 'CUARENTENA' THEN 'NO DISPONIBLE' ELSE 'DISPONIBLE' END  AS  Estatus, c.F_OrdenSuministro as suministro, M.F_NomGen, M.F_FormaFarm, M.F_Concentracion, IFNULL(c.F_FuenteFinanza,'') as FuenteFinanza, M.F_PrePro FROM tb_lote L LEFT JOIN (SELECT F_Lote, F_OrdenSuministro,F_FuenteFinanza FROM tb_compra where F_OrdenSuministro IS NOT NULL group by F_Lote) c on L.F_FolLot = c.F_Lote INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id WHERE L.F_ExiLot>0 AND L.F_Origen = '9' AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995') AND L.F_Proyecto = ? AND F_Ubica NOT IN (%s) AND L.F_FecCad > CURDATE()  GROUP BY L.F_ClaPro, L.F_ClaLot, L.F_FecCad, L.F_Origen, L.F_Proyecto;";
    public static String ExistenciaAbastoRegular = "SELECT P.F_DesProy, M.F_ClaProSS, SUBSTR(M.F_DesPro,1,40) AS F_DesPro, L.F_ClaLot, L.F_FecCad AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri ,L.F_Ubica , CASE WHEN L.F_Ubica = 'CUARENTENA' THEN 'NO DISPONIBLE' ELSE 'DISPONIBLE' END  AS  Estatus, c.F_OrdenSuministro as suministro, M.F_NomGen, M.F_FormaFarm, M.F_Concentracion, IFNULL(c.F_FuenteFinanza,'') as FuenteFinanza, M.F_PrePro FROM tb_lote L LEFT JOIN (SELECT F_Lote, F_OrdenSuministro,F_FuenteFinanza FROM tb_compra where F_OrdenSuministro IS NOT NULL group by F_Lote) c on L.F_FolLot = c.F_Lote INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id WHERE L.F_ExiLot>0 AND L.F_Origen = '10' AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995') AND L.F_Proyecto = ? AND F_Ubica NOT IN (%s) AND L.F_FecCad > CURDATE() GROUP BY L.F_ClaPro, L.F_ClaLot, L.F_FecCad, L.F_Origen, L.F_Proyecto;";
    public static String ExistenciaUNOPS = "SELECT P.F_DesProy, M.F_ClaProSS, SUBSTR(M.F_DesPro,1,40) AS F_DesPro, L.F_ClaLot, L.F_FecCad AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri ,L.F_Ubica , CASE WHEN L.F_Ubica = 'CUARENTENA' THEN 'NO DISPONIBLE' ELSE 'DISPONIBLE' END  AS  Estatus, c.F_OrdenSuministro as suministro, M.F_NomGen, M.F_FormaFarm, M.F_Concentracion, IFNULL(c.F_FuenteFinanza,'') as FuenteFinanza, M.F_PrePro FROM tb_lote L LEFT JOIN (SELECT F_Lote, F_OrdenSuministro,F_FuenteFinanza FROM tb_compra where F_OrdenSuministro IS NOT NULL group by F_Lote) c on L.F_FolLot = c.F_Lote INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id WHERE L.F_ExiLot>0 AND L.F_Origen = '11' AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995') AND L.F_Proyecto = ? AND F_Ubica NOT IN (%s) AND L.F_FecCad > CURDATE() GROUP BY L.F_ClaPro, L.F_ClaLot, L.F_FecCad, L.F_Origen, L.F_Proyecto;";
    public static String ExistenciaSCEstatal = "SELECT P.F_DesProy, M.F_ClaProSS, SUBSTR(M.F_DesPro,1,40) AS F_DesPro, L.F_ClaLot, L.F_FecCad AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri ,L.F_Ubica , CASE WHEN L.F_Ubica = 'CUARENTENA' THEN 'NO DISPONIBLE' ELSE 'DISPONIBLE' END  AS  Estatus, c.F_OrdenSuministro as suministro, M.F_NomGen, M.F_FormaFarm, M.F_Concentracion, IFNULL(c.F_FuenteFinanza,'') as FuenteFinanza, M.F_PrePro FROM tb_lote L LEFT JOIN (SELECT F_Lote, F_OrdenSuministro,F_FuenteFinanza FROM tb_compra where F_OrdenSuministro IS NOT NULL group by F_Lote) c on L.F_FolLot = c.F_Lote INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id WHERE L.F_ExiLot>0 AND L.F_Origen = '13' AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995') AND L.F_Proyecto = ? AND F_Ubica NOT IN (%s) AND L.F_FecCad > CURDATE() GROUP BY L.F_ClaPro, L.F_ClaLot, L.F_FecCad, L.F_Origen, L.F_Proyecto;";
    public static String ExistenciaSCFederal = "SELECT P.F_DesProy, M.F_ClaProSS, SUBSTR(M.F_DesPro,1,40) AS F_DesPro, L.F_ClaLot, L.F_FecCad AS F_FecCad, SUM(L.F_ExiLot) AS F_ExiLot, O.F_DesOri ,L.F_Ubica , CASE WHEN L.F_Ubica = 'CUARENTENA' THEN 'NO DISPONIBLE' ELSE 'DISPONIBLE' END  AS  Estatus, c.F_OrdenSuministro as suministro, M.F_NomGen, M.F_FormaFarm, M.F_Concentracion, IFNULL(c.F_FuenteFinanza,'') as FuenteFinanza, M.F_PrePro FROM tb_lote L LEFT JOIN (SELECT F_Lote, F_OrdenSuministro,F_FuenteFinanza FROM tb_compra where F_OrdenSuministro IS NOT NULL group by F_Lote) c on L.F_FolLot = c.F_Lote INNER JOIN tb_medica M ON L.F_ClaPro = M.F_ClaPro INNER JOIN tb_origen O ON L.F_Origen = O.F_ClaOri INNER JOIN tb_proyectos P ON L.F_Proyecto = P.F_Id WHERE L.F_ExiLot>0 AND L.F_Origen = '12' AND L.F_ClaPro NOT IN ('9999', '9998', '9996', '9995') AND L.F_Proyecto = ? AND F_Ubica NOT IN (%s) AND L.F_FecCad > CURDATE() GROUP BY L.F_ClaPro, L.F_ClaLot, L.F_FecCad, L.F_Origen, L.F_Proyecto;";
