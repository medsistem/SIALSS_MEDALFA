...
/**
 * Generación de reporte global por lote facturación txt isem
 *
 * @author MEDALFA SOFTWARE
 * @version 1.40
 */

public class ReporteGlobaLote extends HttpServlet {
            ...
            if (Radio2 == 1) {////////////  REPORTE GLOBAL RURALES ///////////
                ...
                if (Radio == 1) {//////////  REPORTE GLOBAL  RURALES //////////
                    ...
                    if ((Fecha1 != "") && (Fecha2 != "")) {
                        ...
                        Txt = con.consulta("SELECT F_Contrato FROM tb_txtis WHERE F_fecsur between '" + Fecha1 + "' AND '" + Fecha2 + "' AND F_FacGNKLAgr LIKE 'AG-0%' AND (F_Status <> 'C' OR F_Status='') GROUP BY F_Contrato");
                        while (Txt.next()) {
                        ...
                        F_FecIni = F_Dia1 + "/" + F_Mes1 + "/" + F_Ano1;
                        F_FecFin = F_Dia + "/" + F_Mes + "/" + F_Ano;
                        ...
                        out.println(" <script>window.open('ReportesPuntos/ReporteConcentradoGlobal.jsp?User=" + sesion.getAttribute("nombre") + "&FolCon=" + F_FolCon + "', '', 'width=1200,height=800,left=50,top=50,toolbar=no'); </script>");
                        F_SecIniC = 0;
                        F_SecFinC = 0;
                    ...
                    if ((Fecha1 != "") && (Fecha2 != "")) {
                        ...
                        for (int Reporte = 1; Reporte <= 8; Reporte++) {
                            ...
                            while (TxtSecuenc.next()) {
                                ...
                                if (PzsSur > 0) {
                                    con.actualizar("INSERT INTO tb_imprepconglobal VALUES ('" + TxtSecuenc.getString("F_Cveart") + "','" + TxtSecuenc.getString("F_DesGen") + "','" + TxtSecuenc.getString("F_Canreq") + "','" + TxtSecuenc.getString("F_Cansur") + "','" + F_Cosmed + "','" + F_CosServ + "','" + F_IVA + "','" + TxtSecuenc.getString("F_CosUni") + "','" + F_Total + "','','','','','','','','','','','0','0','','0','','" + F_ClaDyn + "','" + F_DesUni + "','" + F_DesJur + "','" + F_DesRegion + "','" + F_DesMun1 + "','" + F_DesLoc + "','" + F_FolCon + "','" + F_FecIni + "','" + F_FecFin + "','" + F_SecIni + "','" + F_SecFin + "','" + F_Cvepro + "','" + F_Surti + "','" + F_Cober + "','" + F_Sumi + "','" + F_Contrato + "','" + F_FacGNKLAgr + "','" + sesion.getAttribute("nombre") + "',curdate())");
                                    IVA = IVA + F_IVA;
                                    Total = Total + F_Total;
                                    CosServ = CosServ + F_CosServ;
                                    CosMed = CosMed + F_Cosmed;
                                    ...
                                    TxtLoteCont = con.consulta("SELECT F.F_Lote,F.F_ClaPro,L.F_ClaLot,DATE_FORMAT(L.F_FecCad,'%d/%m/%Y') AS F_FecCad, SUM(F.F_CantSur) AS F_CantSur "
                                            + "FROM tb_factura F INNER JOIN tb_lote L ON F.F_Lote=L.F_FolLot "
                        ...
                        for (int Reporteq = 1; Reporteq <= 8; Reporteq++) {
                            ...
                            while (TxtSecuenc.next()) {
                                ...
                                if (PzsSur > 0) {
                                    con.actualizar("INSERT INTO tb_imprepreqglobal VALUES (0,'" + NumReg + "','" + TxtSecuenc.getString("F_Cveart") + "','" + TxtSecuenc.getString("F_DesGen") + "','" + TxtSecuenc.getString("F_Canreq") + "','" + TxtSecuenc.getString("F_Cansur") + "','" + PzsNOSur + "','" + TxtSecuenc.getString("F_CosUni") + "','" + F_Cosmed + "','" + F_CosServ + "','" + F_IVA + "','" + F_Total + "','" + F_DesUni + "','" + F_DesJur + "','" + F_Region + "','" + F_DesMun1 + "','" + F_DesLoc + "','" + F_FolCon + "','" + F_FecIni + "','" + F_FecFin + "','" + F_SecIni + "','" + F_SecFin + "','" + F_Cvepro + "','" + F_Surti + "','" + F_Cober + "','" + F_Sumi + "','" + F_Contrato + "','" + F_FacGNKLAgr + "','" + sesion.getAttribute("nombre") + "',curdate(),'" + F_ClaDyn + "')");
                                    IVA = IVA + F_IVA;
                                    Total = Total + F_Total;
                                    CosServ = CosServ + F_CosServ;
                                    CosMed = CosMed + F_Cosmed;
                                    ...
                                    while (TxtLote.next()) {
                                        ...
                                        TotaLote = CantiLote - CantDesc;
                                        con.actualizar("INSERT INTO tb_imprepreqglobal VALUES (0,'','','" + DesLoteTxt + "','0','" + TotaLote + "','0','0','0','0','0','0','','','','','','" + F_FolCon + "','','','','','" + F_Cvepro + "','','','','','','" + sesion.getAttribute("nombre") + "',curdate(),'')");
                                        if (LoteCont == 0) {
                                            FoliosTxt = "";
                                        }
                                    }
                ...
                if (Radio == 1) { ///// REPORTE GLOBAL FARMACIA /////////
                    if ((Fecha1 != "") && (Fecha2 != "")) {
                        ...
                        for (int Reporte = 1; Reporte <= 8; Reporte++) {
                            ...
                            F_FolCon = "R-" + F_Dia + F_Mes + F_Ano + "." + Reporte;
                            TxtSecuenc = con.consulta("SELECT MIN(F_Secuencial),MAX(F_Secuencial) FROM tb_txtis WHERE F_fecsur between '" + Fecha1 + "' AND '" + Fecha2 + "' AND F_FacGNKLAgr LIKE 'AG-F%' AND (F_Status <> 'C' OR F_Status='') ORDER BY F_Secuencial");
                            while (TxtSecuenc.next()) {
                                F_SecIni = TxtSecuenc.getInt(1);
                                F_SecFin = TxtSecuenc.getInt(2);
                            }
                        ...
                        for (int Reporteq = 1; Reporteq <= 8; Reporteq++) {
                            ...
                            // con.actualizar("delete from tb_imprepval");
                            TxtSecuenc = con.consulta("SELECT MIN(F_Secuencial),MAX(F_Secuencial) FROM tb_txtis WHERE F_fecsur between '" + Fecha1 + "' AND '" + Fecha2 + "' AND F_Idsur = '" + F_Idsur + "' AND F_IdePro = '" + F_IdePro + "' AND F_Cvesum = '" + F_Cvesum + "' AND F_FacGNKLAgr LIKE 'AG-F%' AND (F_Status <> 'C' OR F_Status='') ORDER BY F_Secuencial");
                            while (TxtSecuenc.next()) {
                                F_SecIni = TxtSecuenc.getInt(1);
                                F_SecFin = TxtSecuenc.getInt(2);
                            }
