...
/**
 * Registra compra y selección de lotes
 *
        ...
        try {
            if (request.getParameter("accion").equals("EliminarVerifica")) {
                try {
                    con.conectar();
                    try {
                        con.insertar("delete from volumetria where id IN (SELECT F_IdVolumetria from tb_compratemp where F_FolRemi = '" + request.getParameter("vRemi") + "' and F_OrdCom = '" + request.getParameter("vOrden") + "'); ");
            ...
            if (request.getParameter("accion").equals("GuardarAbiertaVerifica")) {
                try {
                    ...
                    //conModula.conectar();
                    //consql.conectar();
                    String F_ClaPro = "", F_Lote = "", F_FecCad = "", F_FecFab = "", F_Marca = "", F_Provee = "", F_Cb = "", F_Tarimas = "", F_Costo = "", F_ImpTo = "", F_ComTot = "", F_User = "", F_FolRemi = "", F_OrdCom = "", F_Proyecto = "";
                    ...
                    while (rsetDatos.next()) {
                        ...
                        F_Proyecto = rsetDatos.getString("F_Proyectos");
...
//                        }
                        ...
                        if (!(FolioLote.equals(""))) {//Lote existente
                            ...
                            if (!(ExiLote.equals(""))) { //Lote con ubicacion
                                ...
                                con.insertar("insert into tb_lote values (0,'" + F_ClaPro + "','" + F_Lote + "','" + F_FecCad + "','" + F_Piezas + "','" + FolioLote + "','" + F_Origen + "','" + Ubicacion + "','" + F_FecFab + "','" + F_Cb + "','" + F_Marca + "', '" + F_Ori + "','0','0')");
//                                if (Ubicacion.equals("MODULA")) {
...
//                        String F_ClaPrvSQL = "";
                        ...
                        con.insertar("insert into tb_compra values (0,'" + F_IndCom + "','" + F_Provee + "','A',curdate(), '" + F_ClaPro + "', '" + F_Piezas + "', '" + F_Costo + "', '" + F_Caja + "', '0', '" + F_Tarimas + "', '" + F_ImpTo + "' ,'" + F_ComTot + "', '" + FolioLote + "', '" + F_FolRemi + "', '" + F_OrdCom + "', '" + F_Origen + "', '" + F_Cb + "', curtime(), '" + F_User + "','" + F_Obser + "','0','1', '"+sesion.getAttribute("nombre")+"', '"+F_FecApl+"', '"+F_Hora+"') ");
...
//                    correoConfirma.enviaCorreo(F_IndCom);
            ...
            if (request.getParameter("accion").equals("GuardarAbiertaVerificaISEM")) {
                try {
                    ...
                    String FolioLote = "", ExiLote = "", F_Caja = "", F_Resto = "", F_Piezas = "", F_Obser = "", F_Ori = "", F_TarimasI = "", F_CajasI = "", F_RestoI = "";
                    String F_FecApl = "", F_Hora="";
                    int ExiLot = 0, cantidad = 0, sumalote = 0, FolLot = 0, FolioLot = 0, F_IndComT = 0, F_Origen = 0, FolMov = 0, FolioMovi = 0, FolMovSQL = 0, FolioMoviSQL = 0;
                    double compraB = 0.0;
                     ...
                     *con base en fecha y usuario
                     */
                    ResultSet rsetDatos = con.consulta("SELECT F_ClaPro, F_Lote, F_FecCad,DATE_FORMAT(F_FecCad,'%d/%m/%Y') AS FECAD, F_FecFab, F_Marca, F_Provee, F_Cb, F_Tarimas, F_Cajas, F_Pz, F_Resto, F_Costo,F_ImpTo, F_ComTot, F_FolRemi, F_OrdCom, F_ClaOrg, F_User, F_Obser, F_Origen,F_TarimasI,F_CajasI FROM tb_compratempisem WHERE F_OrdCom='" + request.getParameter("vOrden") + "' and F_FolRemi = '" + request.getParameter("vRemi") + "' ");
                    while (rsetDatos.next()) {
                        F_ClaPro = rsetDatos.getString("F_ClaPro");
                        F_Lote = rsetDatos.getString("F_Lote").toUpperCase();
                        F_FecCad = rsetDatos.getString("F_FecCad");
...
//ConectionDB_SQLServer conModula = new ConectionDB_SQLServer();
            ...
            if (request.getParameter("accion").equals("GuardarVerifica")) {
                try {
                     ...
                     *con base en fecha y usuario
                     */
                    ResultSet rsetDatos = con.consulta("SELECT F_ClaPro, F_Lote, F_FecCad,DATE_FORMAT(F_FecCad,'%d/%m/%Y') AS FECAD, F_FecFab, F_Marca, F_Provee, F_Cb, F_Tarimas, F_Cajas, SUM(F_Pz) AS F_Pz,SUM(F_Resto) AS F_Resto, F_Costo,SUM(F_ImpTo) AS F_ImpTo,SUM(F_ComTot) AS F_ComTot, F_FolRemi, F_OrdCom, F_ClaOrg, F_User, F_Obser, F_Origen FROM tb_compratemp WHERE F_OrdCom='" + request.getParameter("vOrden") + "' and F_FolRemi = '" + request.getParameter("vRemi") + "' GROUP BY F_ClaPro,F_Lote,F_FecCad,F_Origen ");
                    while (rsetDatos.next()) {
                        F_ClaPro = rsetDatos.getString("F_ClaPro");
                        F_Lote = rsetDatos.getString("F_Lote").toUpperCase();
                        F_FecCad = rsetDatos.getString("F_FecCad");
                         ...
                         *Se extrae fol_lote de F_FolLot para agregar o generar uno nuevo
                         */
//                        ResultSet rsetLote = con.consulta("SELECT F_FolLot FROM tb_lote WHERE F_ClaPro='" + F_ClaPro + "' and F_ClaLot='" + F_Lote + "' and F_FecCad='" + F_FecCad + "' and F_Origen = '" + F_Ori + "' ");
//                        while (rsetLote.next()) {
//                            //System.out.println(rset.getString("F_FolLot"));
//                            FolioLote = rsetLote.getString("F_FolLot");
//                        }
                        ...
                        con.insertar("insert into tb_compra values (0,'" + F_IndCom + "','" + F_Provee + "','A',curdate(), '" + F_ClaPro + "', '" + F_Piezas + "', '" + F_Costo + "', '" + F_Caja + "', '0', '" + F_Tarimas + "', '" + F_ImpTo + "' ,'" + F_ComTot + "', '" + FolioLote + "', '" + F_FolRemi + "', '" + F_OrdCom + "', '" + F_Origen + "', '" + F_Cb + "', curtime(), '" + (String) sesion.getAttribute("nombre") + "','" + F_Obser + "','0','1', '"+sesion.getAttribute("nombre")+"', '"+F_FecApl+"', '"+F_Hora+"') ");
                        FolioLote = "";
                        FolioLoteSQL = "";
            ...
            if (request.getParameter("accion").equals("GuardarVerificaISEM")) {
                try {
                    ...
                    String F_ClaPro = "", F_Lote = "", F_FecCad = "", F_FecFab = "", F_Marca = "", F_Provee = "", F_Cb = "", F_Tarimas = "", F_Costo = "", F_ImpTo = "", F_ComTot = "", F_User = "", F_FolRemi = "", F_OrdCom = "";
                    String FolioLote = "", ExiLote = "", F_Caja = "", F_Resto = "", F_RestoI = "", F_Piezas = "", F_Obser = "", F_Ori = "", F_TarimasI = "", F_CajasI = "";
                    String F_FecApl="", F_Hora="";
                    int ExiLot = 0, cantidad = 0, sumalote = 0, FolLot = 0, FolioLot = 0, F_IndComT = 0, F_Origen = 0, FolMov = 0, FolioMovi = 0, FolMovSQL = 0, FolioMoviSQL = 0;
                    double compraB = 0.0;
                     ...
                     *con base en fecha y usuario
                     */
                    ResultSet rsetDatos = con.consulta("SELECT F_ClaPro, F_Lote, F_FecCad,DATE_FORMAT(F_FecCad,'%d/%m/%Y') AS FECAD, F_FecFab, F_Marca, F_Provee, F_Cb, F_Tarimas, F_Cajas, SUM(F_Pz) AS F_Pz,SUM(F_Resto) AS F_Resto, F_Costo,SUM(F_ImpTo) AS F_ImpTo,SUM(F_ComTot) AS F_ComTot, F_FolRemi, F_OrdCom, F_ClaOrg, F_User, F_Obser, F_Origen,F_TarimasI,F_CajasI FROM tb_compratempisem WHERE F_OrdCom='" + request.getParameter("vOrden") + "' and F_FolRemi = '" + request.getParameter("vRemi") + "' GROUP BY F_ClaPro,F_Lote,F_FecCad,F_Origen;");
                    while (rsetDatos.next()) {
                        F_ClaPro = rsetDatos.getString("F_ClaPro");
                        F_Lote = rsetDatos.getString("F_Lote").toUpperCase();
                        F_FecCad = rsetDatos.getString("F_FecCad");
...
//                    Lerma.cierraConexion();
            ...
            if (request.getParameter("accion").equals("Eliminar")) {
                ...
                try {
                    ...
                    try {
                        //con.insertar("delete from tb_compratemp where F_FolRemi = '" + request.getParameter("folioRemi") + "' and F_OrdCom = '" + request.getParameter("NoCompra") + "' ");
                        con.insertar("delete from volumetria where id IN (SELECT F_IdVolumetria from tb_compratemp where F_OrdCom = '" + request.getParameter("fol_gnkl") + "' AND F_Estado = 1 ); ");
                        con.insertar("delete from tb_compratemp where F_OrdCom = '" + request.getParameter("fol_gnkl") + "' AND F_Estado = 1 ");
                    } catch (Exception e) {
               ...
               // sesion.setAttribute("folioRemi", "0");
